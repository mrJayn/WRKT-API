...
"""
from static.countries_data import COUNTRIES

locale_choices = [(code, {"name": country}) for code, country in COUNTRIES.items()]
"""


class CountryCodes(models.TextChoices):
    """
    The two letter country code text choices as defined in `ISO 3166-1`.
    all codes: https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes
    """
